...
function PrivateRoute({children,admin}) { // profile icin undefined doner // admin icin true doner
    ...
    // sayfayi yenileyince yineyonlendiriyor. fetch gec geldigi icin
    if(admin && user?.role !=="admin"){  // useAuth fetch attigidan dolayi veriler biraz gecikmeli geliyor. bu yuzden user i basta null donuyor, fetch degeri dondukten sonra user verisini donuyor.
